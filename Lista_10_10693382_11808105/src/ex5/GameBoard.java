...
public class GameBoard {
	...
	*/
	...
	//Não é sempre bom fazer uma chamada de função deste tipo, pois a função repetida pode
	//ter sido pensada para retornar valores diferentes a depender do instante em que ela é chamada.
	//Criando a variável local e atribuindo a ela o retorno da função, essa variável terá conteúdo constante
	//durante a execução da função e pode impactar na exatidão do programa, isto é, o conteúdo da String
	//colorGroup só é passível de atualização quando o método addCell for chamado novamente, o que pode não ser o
	//desejado.
